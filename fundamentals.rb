...
and then i want to access venue that are wheelchair accessible
and which have a capacity of greater than 150
i want to push the hash that meets this criteria into its own array
=end
